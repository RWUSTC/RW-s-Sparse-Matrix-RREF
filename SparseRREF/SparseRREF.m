...
SRSparseRowReduce[e_SparseArray, Modulus->f_Integer] :=
        SRRREF[SRSparsePos[e], SRSparseValues[e], SRSparseDims[e], SRNonZeroValues[e], f];

srrreflib = $Failed;

SRLoadLib[] := Module[
    {},
    srrreflib = FindLibrary["SparseRREF"];  
    sprreflib = FindLibrary["libspasm"]; 
